...
function writeData(name, data) {
    ...
    fs.writeFile(data_path + "/" + name + ".json", JSON.stringify(data), function (err) {
...
module.exports = {
    ...
    init() {
        ...
        loadJson(data_path, function (item) {
            ...
            let data = fs.readFileSync(data_path + "/" + item)
